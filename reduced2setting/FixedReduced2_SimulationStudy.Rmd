...
fit_models <- function(data) {
  models <- list(
    full = lmer(y ~ x1 + x2 + x3 + (1|group_id), data = data, REML = FALSE),
    reduced1 = lmer(y ~ x1 + x2 + (1|group_id), data = data, REML = FALSE),
    reduced2 = lmer(y ~ x1 + x3 + (1|group_id), data = data, REML = FALSE),
    reduced3 = lmer(y ~ x2 + x3 + (1|group_id), data = data, REML = FALSE)
  )
  return(models)
}
